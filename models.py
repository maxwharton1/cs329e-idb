...
import os
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("DB_STRING",'postgres://postgres:asd123@/postgres?host=/cloudsql/cs329e-idb-235601:uscentral1:sharks1')
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = True # to suppress a warning message
db = SQLAlchemy(app)

class Shark(db.Model):
    __tablename__ = 'sharks1'
